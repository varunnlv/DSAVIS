...
const SelectionSort = () => {
  ...
  for (let i = 0; i < tempData.length - 1; i++) {
    ...
    for (let j = i + 1; j < tempData.length; j++) {
      ...
      resetHighlight(minIndex, j);
    }

    await highlightLine("line-6"); 
    // If the minimum is not the element at index i, swap them
    if (minIndex !== i) {
      ...
      await animateSwap(tempData[i], tempData[minIndex], tempData);
          ...
          <div className="row mx-auto">
            <div className="col-sm-12 col-md-12 col-lg-6 px-0 mr-0">
              <div className="ide w-100">
                {/* Lines for sorting explanation */}
                <div className="row ml-auto mr-auto" id="line-1">
                  <span><span className="op">for</span>(i = 0 to length(list)-1)</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-2">
                  <span>&emsp;&emsp;min = i</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-3">
                  <span>&emsp;&emsp;<span className="op">for</span>(j = i+1 to length(list))</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-4">
                  <span>&emsp;&emsp;&emsp;&emsp;<span className="op">if</span>(list[j] &lgt; list[min])</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-5">
                  <span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;min = j</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-6">
                  <span>&emsp;&emsp;<span className="op">if</span>(min != i)</span>
                </div>
                <div className="row ml-auto mr-auto mt-1" id="line-7">
                  <span>&emsp;&emsp;&emsp;&emsp;<span className="op">swap</span>(list[i], list[min])</span>
                </div>
              </div>
            </div>

            {/* Short explanation on the right side */}
            <div className="col-sm-12 col-md-12 col-lg-6 ml-0 px-0">
              <div className="ide w-100 pl-0">
                ...
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">1. Set the first unsorted element as the minimum.</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">2. Iterate through the rest of the list to find the true minimum.</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">3. Swap the minimum with the first unsorted element to build the sorted sublist.</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">4. Repeat steps 1 to 3 until the whole list is sorted.</span>
                </div>
              </div>
            </div>
          </div>
