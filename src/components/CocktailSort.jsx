  ...
  const bubbleSort = async () => {
    ...
    while (swapped) {
      await highlightLine("line-2");
        ...
        await highlightLine("line-3"); // Highlight the swap line
        ...
        end--; // Decrease the end index after the forward pass

        // Check if any swaps happened in the forward pass
        ...
        for (let i = end; i > start; i--) {
            ...
            await highlightLine("line-10"); // Highlight the if statement
            ...
            resetHighlight(i - 1, i);
        }
        start++; // Increase the start index after the backward pass
    }
          ...
          <div className="row mx-auto">
            ...
            <div className="ide w-100">
                ...
                <div className="row ml-auto mr-auto mt-1 3" id="line-3">
                  <span>&emsp;&emsp;<span className="op">for</span> x = 0 to length(list)-1</span>
                </div>
                <div className="row ml-auto mr-auto mt-1 4" id="line-4">
                  <span>&emsp;&emsp;&emsp;&emsp;<span className="op">if</span> list[x] &gt; list[x+1]</span>
                </div>
                <div className="row ml-auto mr-auto mt-1 5" id="line-5">
                  <span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span className="op">swap</span>(list[x], list[x+1])</span>
                </div>
                <div className="row ml-auto mr-auto mt-1 6" id="line-6">
                  <span>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;swapped = <span className="var">true</span></span>
                </div>
                <div className="row ml-auto mr-auto mt-1 7" id="line-7">
                  <span>&emsp;&emsp;<span className="op">if</span>(swapped == <span className="var">false</span>)</span>
                </div>
                <div className="row ml-auto mr-auto mt-1 8" id="line-8">
                  <span>&emsp;&emsp;&emsp;&emsp;<span className="op">break</span></span>
                </div>
                <div className="row ml-auto mr-auto mt-1 9" id="line-9">
                  <span>&emsp;&emsp;<span className="op">for</span> x = length(list)-2 to 0</span>
                </div>
            ...
            <div className="col-sm-12 col-md-12 col-lg-6 ml-0 px-0">
              <div className="ide w-100 pl-0">
                ...
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">1. Starting at index 0, compare the current element with the next element</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">- If the current element is greater than the next element, swap them</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">- If the current element is less than the next element, move to the next element</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">2. Repeat Step 1 until at the last index</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">3. Starting at index length(list)-2, compare the current element with the next element</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">- If the current element is greater than the next element, swap them</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">- If the current element is less than the next element, move to the previous element</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">4. Repeat Step 3 until at the first index</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
                  <span className="comment">5. Start over from Step 1 until the list is sorted</span>
                </div>
                <div className="row ml-auto mr-auto mt-1">
